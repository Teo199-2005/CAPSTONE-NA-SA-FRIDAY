...
<div class="d-flex justify-content-between align-items-center mb-4">
  <div>
    ...
    <small class="text-muted">
      <i class="bi bi-calendar me-1"></i><?= date('F j, Y \a\t g:i A', strtotime($announcement['published_at'])) ?>
    </small>
  </div>
  <a href="<?= base_url('student/announcements') ?>" class="btn btn-outline-secondary">
