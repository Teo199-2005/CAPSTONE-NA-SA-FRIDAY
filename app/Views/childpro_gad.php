...
<section class="childpro-gad-page" id="landing">
    ...
    <?php if ($heroUrl !== ''): ?>
    <?php
        $heroExt = strtolower(pathinfo(parse_url($heroUrl, PHP_URL_PATH), PATHINFO_EXTENSION));
        $isHeroVideo = in_array($heroExt, ['mp4', 'webm', 'ogg', 'mov']);
    ?>
    <?php if ($isHeroVideo): ?>
    <!-- Hero with video background -->
    <div class="cg-hero cg-hero--with-image">
        <div class="cg-hero__stage">
            <video autoplay muted loop playsinline class="cg-hero__img" style="width: 100%; height: 100%; object-fit: cover;">
    ...
    <div class="cg-hero cg-hero--with-image">
        <div class="cg-hero__stage">
            <img
                src="<?= esc($heroUrl) ?>"
                alt="<?= esc($hero['title'] ?: $tabLabel . ' hero image') ?>"
                class="cg-hero__img"
                width="1983"
                height="793"
                loading="lazy"
    ...
    <?php endif; ?>
    <?php else: ?>
    <!-- Hero text-only (matches about-page-hero) -->
    <div class="cg-hero">
    ...
    <div class="cg-empty">
        ...
        <p>The <?= esc($tabLabel) ?> page content is being prepared. Please check back later.</p>
    </div>
    <?php endif; ?>
    <?php endif; ?>
